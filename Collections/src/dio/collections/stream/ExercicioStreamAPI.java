package dio.collections.stream;
...
//        System.out.println(numerosAleatorios5Primeiros);
        ...
        numerosAleatorios.stream()
                .limit(5)
                .collect(Collectors.toSet()) // colete os 5 primeiro elementos e coloque numa lista de um set
                .forEach(System.out::println);//lembrando que o Set não aceita números repetidos
...
//                .map(Integer::parseInt).collect(Collectors.toList());
     ...
     numerosAleatorios.stream()
             .map(Integer::parseInt)
             .collect(Collectors.toList()) // colete os 5 primeiro elementos e coloque numa lista de um set
             .forEach(System.out::println);
